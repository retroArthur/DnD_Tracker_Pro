...
- [x] 13-03-PLAN.md — MAINT-03: toter `hasHtmlTags`-Wächter entfernt, Unterstrich-Wortgrenzen nach CommonMark (Welle 1)
- [x] 13-04-PLAN.md — MAINT-05 + MAINT-02: Interval-Guard, Tab-Registry auf Funktionsreferenzen, tote `mindmap`-Seeds und `const D`-Überschattung weg (Welle 1)
- [x] 13-05-PLAN.md — MAINT-01/D-04: Charakterisierungs-Snapshot für `dmscreen-render.js` gegen das UNGETEILTE Modul, vor jeder Verschiebung (Welle 1)
- [x] 13-06-PLAN.md — PERF-01: Save-Pfad ohne zweite Vollkopie, Undo-Dedupe und Byte-Budget, Messprotokoll zu Erfolgskriterium 2 (Welle 1)
...
- [x] 13-11-PLAN.md — MAINT-01: `ui/editors/rich-text.js` entflochten und aufgeteilt, Zauberverwaltung zieht aus (Welle 6, Bedienprobe)
...
- [x] 14-04-PLAN.md — TEST-04 / D-04…D-06: E2E-Sammel-Spec in fünf dedizierte Dateien aufgeteilt (Welle 2)
- [x] 14-05-PLAN.md — TEST-04 / D-04/D-05: Unit-Sammeldatei in fünf dedizierte Dateien aufgeteilt (Welle 2)
