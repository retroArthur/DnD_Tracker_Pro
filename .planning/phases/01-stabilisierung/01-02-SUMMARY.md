...
dependency_graph:
  ...
  affects: [systems/spellslots/persistence.js, systems/spellslots/quick-roll.js, tests/unit/stability.test.js]
tech_stack:
  added: []
  patterns: [companion-timestamp, stale-shadow-removal, idb-only-mode-gate, legacy-version-normalization, source-audit-tests]
key_files:
  created: []
  modified:
