...
| N21 | Testartefakte (`_smoke_*.png`) liegen im `dist/`-Verzeichnis | Build & Architektur | **erledigt** (2026-07-29 entfernt, zusammen mit `test-script.html`) | `dist/_smoke_fraktionen.png` u. a. (Zeitstempel 15. Juni); `dist/` ist nicht versioniert (`git log -- dist` liefert keine Commits) — reine Aufraeumarbeit ohne funktionalen Impact |
