...
- **Zeile 5** (Mindmap-Residuum, `erledigt`) — `systems/backups.js:232` war als Lese-Kompat-Pfad beschrieben; es ist ein Schreib-seitiger Schema-Seed. Zusaetzlich wurden die beiden in `CONCERNS.md:47` genannten Stale-Referenzen geprueft und unterschieden (eine live, eine inert), neuer Rest-Posten DEBT-16.
