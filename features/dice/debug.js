...
const ENTITY_TYPE_CONFIG = window.ENTITY_TYPE_CONFIG;
const renderEntityLink = window.renderEntityLink;
const ErrorHandler = window.ErrorHandler;
const ENTITY_SCHEMAS = window.ENTITY_SCHEMAS;
const safeJSONParse = window.safeJSONParse;
const safeJSONStringify = window.safeJSONStringify;
const repairDataArrays = window.repairDataArrays;
...
const QREF_CONDITIONS = window.QREF_CONDITIONS;
const toggleQuickRef = window.toggleQuickRef;
const applyQrefCondition = window.applyQrefCondition;
const rollQrefDice = window.rollQrefDice;
const qrefSearch = window.qrefSearch;
const toggleEventLog = window.toggleEventLog;
const clearEventLog = window.clearEventLog;
const parseWikiLinks = window.parseWikiLinks;
const navigateToWikiEntry = window.navigateToWikiEntry;
const addNode = window.addNode;
const saveNodeFromModal = window.saveNodeFromModal;
const selectNodeType = window.selectNodeType;
