...
describe('Entity Operations', () => {
    ...
    describe('NPCs', () => {
        ...
        test('sollte NPC-Trigger verwalten', () => {
            const npc = createTestNPC({
                triggers: [
                    { condition: 'Spieler fragt nach Gerüchten', reveal: 'Es gibt Goblins im Wald', triggered: false },
                    { condition: 'Spieler zeigt Siegel', reveal: 'Der NPC vertraut der Gruppe', triggered: false }
                ]
            });
            D.npcs.push(npc);
        ...
        test('sollte NPC-Dialoge verwalten', () => {
            const npc = createTestNPC({
                dialogs: [
                    ...
                    { title: 'Geheimnis', triggerCondition: 'Nach Vertrauen', text: 'Ich weiß etwas...', used: false }
                ]
            });
            D.npcs.push(npc);
...
describe('Filter & Search', () => {
    ...
    test('sollte nach Name filtern', () => {
        const query = 'ara';
        const filtered = D.npcs.filter(n => 
    ...
    test('sollte nach Rolle filtern', () => {
        const role = 'Zauberer';
        const filtered = D.npcs.filter(n => 
            n.role.toLowerCase().includes(role.toLowerCase())
        );
