...
test.describe('Party Tab', () => {
  ...
  test('Charakter-Formular ist zugänglich', async ({ page }) => {
    ...
    const formToggle = page.locator('[data-action="toggle-collapse"][data-value="char-form"]').first();
...
test.describe('Würfel Tab', () => {
  ...
  test('D20 Würfel kann geworfen werden', async ({ page }) => {
    const d20Button = page.locator('[data-action="roll-dice"][data-value="d20"], .dice-btn[data-dice="d20"]');
