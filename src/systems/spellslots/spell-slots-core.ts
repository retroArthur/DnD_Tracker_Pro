 ...
 */
export const SPELL_SLOT_TABLE: Readonly<Record<number, number[]>> = Object.freeze({
 ...
 */
export const HALF_CASTER_TABLE: Readonly<Record<number, number[]>> = Object.freeze({
 ...
 */
export const THIRD_CASTER_TABLE: Readonly<Record<number, number[]>> = Object.freeze({
 ...
 */
export const CASTER_CLASSES: Readonly<Record<string, ReadonlyArray<string>>> = Object.freeze({
 ...
 */
export function getSpellSlotsForClass(characterClass: string, level: number): number[] {
