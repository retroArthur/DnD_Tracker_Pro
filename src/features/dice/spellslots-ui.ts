...
export function toggleSpellSlot(charId: number | string, level: number): void {
    const ch = EntityLookup.character(charId);
...
export function restoreAllSpellSlots(charId: number | string): void {
    const ch = EntityLookup.character(charId);
...
export function renderSpellSlotPips(charId: number | string): string {
...
(window as any).getSpellSlots = getSpellSlots;
(window as any).toggleSpellSlot = toggleSpellSlot;
(window as any).restoreAllSpellSlots = restoreAllSpellSlots;
(window as any).renderSpellSlotPips = renderSpellSlotPips;
